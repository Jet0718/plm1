...
class PCOProductModel(models.Model):
    ...
    affected_item_id =fields.Many2one('ir.attachment',string='審批文件',options={'no_create': True}, ondelete='cascade', auto_join=True, copy=False,domain="['&',('engineering_code', '!=', ''),('is_plm', '=', True),('engineering_state', 'not in', ['obsoleted','undermodify']) ,('res_model','=',False),('active','=',True)]")
