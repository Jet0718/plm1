...
class InhtProjectModel(models.Model):
    ...
    dmsfile_ids = fields.One2many('ir.attachment','cn_file2prj',domain="['&',('engineering_code', '!=', ''),('is_plm', '=', True),('engineering_state', 'not in', ['obsoleted','undermodify']) ,('res_model','=',False),('active','=',True)]")
